...
pub mod file {
    ...
    impl Magic{
        ...
        pub fn from_file(mut file: &std::fs::File) -> Result<Magic> {
    ...
    impl Identification {
        ...
        pub fn from_file(file: &std::fs::File) -> Result<Identification> {
            let magic = Magic::from_file(file)?;
            Ok(Identification {
                magic
            })
        }
    ...
    impl Header {
        pub fn from_file(file: &std::fs::File) -> Result<Header> {
            let ident = Identification::from_file(file)?;
            Ok(Header {
                ident
            })
        }
